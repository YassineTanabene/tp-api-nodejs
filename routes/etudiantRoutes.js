...
// Route: /api/v1/etudiants/search?q=term
// GET    → Recherche sur le nom OU le prénom (insensible à la casse)
router.get('/search', searchEtudiants);

// Route: /api/v1/etudiants/inactifs
// GET    → Liste des étudiants désactivés
router.get('/inactifs', getEtudiantsInactifs);

// Route: /api/v1/etudiants/:id
